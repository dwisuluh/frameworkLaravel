...
class PropinsiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('propinsi.index')->with('message','Propinsi baru berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('propinsi.index')->with('message','Propinsi baru berhasil diubah');
    }
    ...
    {
        $propinsi = Propinsi::findOrFail($id)->delete();
